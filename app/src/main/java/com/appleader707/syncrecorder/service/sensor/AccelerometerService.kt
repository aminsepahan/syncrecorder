...
class AccelerometerService @Inject constructor(
    ...
    fun startAccelerometerSensor(
        ...
        val sensorFile = File(
            ...
            "accelerometer_data_$recordingCount.jsonl"
        )
    ...
    fun stopAccelerometerSensor(
        ...
        convertJsonToSrtUseCase("accelerometer_data_$recordingCount.jsonl", "accelerometer_data_$recordingCount.srt")
        sensorData.clear()
    }
}
