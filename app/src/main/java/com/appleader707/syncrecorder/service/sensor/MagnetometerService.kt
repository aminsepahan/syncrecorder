...
class MagnetometerService @Inject constructor(
    ...
    fun startMagnetometerSensor(
        ...
        val sensorFile = File(
            ...
            "magnetometer_data_$recordingCount.jsonl"
        )
    ...
    fun stopMagnetometerSensor(recordingCount: Int) {
        ...
        convertJsonToSrtUseCase("magnetometer_data_$recordingCount.jsonl", "magnetometer_data_$recordingCount.srt")
        sensorData.clear()
    }
}
